...
<html>
	<head>
		...
		<script type="text/javascript" src="js/teaInsert.js"></script>
		<meta charset="utf-8">
		<title>教师信息管理</title>
		<style type="text/css">
...
table tbody {
		...
		<body >
		<div  class="bg">
			<div class="hstu"><h1>教师信息管理</h1></div>
			<div>
			<div class="left">
				<ul>
				...
				<table class="right" id="pro" border="1px"  onclick="selectrow(this)" > <!-- onmouseover="getrow(this)" onmouseout="backrow(this)" -->
					<tr>
					 ...
					 <%				  
			           ...
			           List<Teacher> list =dao.getAllTea();   
        ...
        <a class='x' href='' onclick="msgbox(0); return false;">关闭</a>
			...
			<form action="GetTeaByNoServelt" method="post">
