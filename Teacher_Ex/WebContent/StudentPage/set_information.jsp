...
<td align="center"><%=session.getAttribute("QQ") %></td>
</tr>
<tr>
...
<td align="center"><%=session.getAttribute("hobby") %></td>
</tr>
<tr>
<td align="center">签&nbsp;&nbsp;名：</td>
<td align="center"><%=session.getAttribute("tip") %></td>
</tr>
<tr>
<td align="center" colspan="2">
<a href="edit_information.jsp">编辑资料</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="StudentPage.jsp">返回</a></td>
</tr>
</table>
    </div>
    </div>
