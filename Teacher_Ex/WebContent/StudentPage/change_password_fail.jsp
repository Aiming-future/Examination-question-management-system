...
<td align="center"></td>
    ...
    <div class="main">
    <div class="dadada">
    <form action="../change_password.html"  method="post"><br/><br/>
        请输入原密码：<input type="password" style="width:250px; height:20px "name="password" placeholder="请输入原密码"/><br/><br/>
        请输入新密码：<input type="password" style="width:250px; height:20px "name="newpassword" placeholder="请输入原密码"/><br/><br/><br/>
    <input  type="submit" style="width:100px; height:40px " value="确  定">
    <div class="fanhui"><a href="StudentPage.jsp">返回</a></div>
    <font color="red">密码错误，请重试！</font>
    </div>
    </div>
    <div class="right">
        <div class="left_up">
